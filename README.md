...
see its full live, fully-interactive showcase page.
...
inline (Google Fonts is the only external dependency), so each one works by
double-clicking it. Every page reproduces the same component set: sticky nav,
hero, bento grid (music player, switches, dial, slider, segmented control,
...
Memphis · Bohemian · Shabby Chic · Cottagecore · Victorian · Art Deco ·
Art Nouveau · Mystical Western · Kitsch · Y2K · Bauhaus · Brutalism · Cybercore
· Synthwave · Vaporwave · Pop Art · Bento Box · Graffiti · Tenebrism · Gothic ·
